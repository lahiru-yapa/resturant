	...
	<div class="page-wrapper">
					...
					<div class="clearfix">
						...
						<div class="top-left">
							...
							<ul class="info-list">
								...
								<li><a href="tel:786-875-864-75"><span class="icon flaticon-telephone"></span> 786 875
										864 75</a></li>
							</ul>
						</div>
					...
					<div class="auto-container">
						...
						<div class="content-column">
							<div class="inner-column">
								...
								<div class="text">We are 100+ professional software engineers with more than <br> 10
									years of experience in delivering superior products.</div>
								<div class="btns-box">
									<a href="about.html" class="theme-btn btn-style-one"><span class="txt">Learn
											More</span></a>
								</div>
							</div>
						</div>
			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="button-column col-lg-4 col-md-12 col-sm-12">
						<div class="inner-column">
							<a href="contact.html" class="theme-btn btn-style-two"><span class="txt">Meet With
									Us</span></a>
						</div>
					</div>
				</div>
		...
		<section class="cases-section">
			<div class="auto-container">
						...
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/gallery/1.jpg" data-fancybox="case" data-caption=""
					...
					<div class="case-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/gallery/2.jpg" data-fancybox="case" data-caption=""
										class="search-icon"><span class="icon flaticon-search"></span></a>
									<div class="content">
										<h4><a href="projects-detail.html">Social Media App</a></h4>
										<div class="category">Ideas / Technology</div>
					...
					<div class="case-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/gallery/3.jpg" data-fancybox="case" data-caption=""
										class="search-icon"><span class="icon flaticon-search"></span></a>
									<div class="content">
										<h4><a href="projects-detail.html">Social Media App</a></h4>
										<div class="category">Ideas / Technology</div>
					...
					<div class="case-block col-lg-6 col-md-12 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/gallery/4.jpg" data-fancybox="case" data-caption=""
										class="search-icon"><span class="icon flaticon-search"></span></a>
									<div class="content">
										<h4><a href="projects-detail.html">Social Media App</a></h4>
										<div class="category">Ideas / Technology</div>
					...
					<div class="case-block col-lg-6 col-md-12 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<div class="overlay-box">
									<a href="images/gallery/5.jpg" data-fancybox="case" data-caption=""
										class="search-icon"><span class="icon flaticon-search"></span></a>
									<div class="content">
										<h4><a href="projects-detail.html">Social Media App</a></h4>
										<div class="category">Ideas / Technology</div>
				...
				<div class="section-text">We Have Done More Than 1K Projects in Last 3 Years, With 100% Satisfaction.
				</div>
		...
		<section class="testimonial-section">
			<div class="auto-container">
				...
				<div class="testimonial-carousel owl-carousel owl-theme">
					...
					<div class="testimonial-block">
						<div class="inner-box" style="background-image: url(images/background/pattern-4.png)">
							...
							<div class="text">"Very well thought out and articulate communication. Clear milestones,
								deadlines and fast work. Patience. Infinite patience. No shortcuts. Even if the client
								is being careless. The best part...always solving problems with great original ideas!."
							</div>
						</div>
					</div>
				...
				<div class="lower-text">More than 5k customers share their thoughts to us. . . <a
						href="testimonial.html">Read All Reviews</a></div>
							...
							<div class="row clearfix">
								...
								<div class="footer-column col-lg-7 col-md-6 col-sm-12">
									<div class="footer-widget logo-widget">
										...
										<div class="text">We are the best world Information Technology Company.
											Providing the highest quality in hardware & Network solutions. About more
											than 25 years of experience and 1000 of innovative achievements.</div>
										<!-- Social Box -->
										<ul class="social-box">
											<li><a href="#" class="fa fa-facebook-f"></a></li>
									...
									<div class="footer-widget news-widget">
										...
										<div class="widget-content">
											<div class="post">
												...
												<h6><a href="news-detail.html">Define World Best IT Solution
														Technology</a></h6>
											...
											<div class="post">
												...
												<h6><a href="news-detail.html">PHP Frameworks You Need To Use
														Anywhere</a></h6>
												<span class="date">May 01, 2020</span>
											</div>
										</div>
					...
					<div class="auto-container">
						<div class="row clearfix">
							...
							<div class="column col-lg-6 col-md-12 col-sm-12">
								<div class="copyright">Copyright &copy; 2020 by expert-themes. All Rights Reserved.
								</div>
							</div>
							<!-- Column -->
							<div class="column col-lg-6 col-md-12 col-sm-12">
